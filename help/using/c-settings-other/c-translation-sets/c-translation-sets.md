...
您可以為所有應用程式（Storify 2除外）指定翻譯設定。 如需可本地化的欄位的詳細資訊，請參閱[本地化字串](/help/using/c-settings-other/c-translation-sets/c-localize-strings.md#c-localize-strings)。
...
| 元素 | 金鑰 | 預設文字 |
|---|---|---|
| 資訊菜單選項 | menuInfoCopyright | © Livefyre, Inc. 2014 |
|  | menuInfoHelp | 說明 |
...
|  | datetimeMonths | 陣列. 預設=[ &#39;Janury&#39;、&#39;二月&#39;、&#39;March&#39;、&#39;April&#39;、&#39;May&#39;、&#39;June&#39;、&#39;July&#39;、&#39;August&#39;、&#39;Sember&#39;、&#39;Onctom&#39;、&#39;Rovel&#39;、&#39;Precke&#39;] |
|  | 問題說明 | 您現在可以直接閱讀和撰寫句子、段落、影像和引號的注釋。<br><br><span class="&rdquo;lf-highlight-text&rdquo;">反</span> 白顯示文本， <span class="&rdquo;fycon-write&rdquo;"></span> 然後按一下圖 <span class="&rdquo;fycon-action-view&rdquo;"></span> 示或按一下每個段落結尾的圖示。 |
...
|  | menuShareTitle | 共用 |
| 標幟功能表選項 | menuFlagOptionDiscore | 不同意 |
...
| 等功能表選項 | menuEtcOptionApprove | 核准 |
...
| 元素 | 金鑰 | 預設文字 |
|---|---|---|
| 從「更多」功能表顯示確認訊息 | notificationApproved | 已核准 |
